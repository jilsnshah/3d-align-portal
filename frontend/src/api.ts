 ...
 *
 *  Lists were printing "09 Sept 2026, 05:14 pm" against every row — an absolute
 *  time, identical on all of them, answering a question nobody asked. What a
 *  clinic and a lab both want to know is how long a thing has been sitting,
 *  because that is what decides which one to open first.
 */
export function since(iso: string | null): string {
  ...
  // A clock a few seconds out of step should not read as the future.
